  ...
  const troubleshootingItems: TroubleshootingItem[] = [
    {
      ...
      causes: [
        ...
        'Insufficient account balance in Sinch ClickSend',
        'Sinch ClickSend number not properly configured',
        'Recipient\'s carrier blocking messages',
        'API credentials are incorrect but validation passed',
        'Network issues between your server and Sinch ClickSend'
      ],
      solutions: [
        ...
        'Verify Sinch ClickSend account balance is sufficient',
        'Confirm Sinch ClickSend number is active and SMS-enabled',
        'Test with a different phone number/carrier',
        'Check Sinch ClickSend delivery logs in their dashboard',
    ...
    },
    {
      ...
      description: 'Unable to connect to Sinch ClickSend API due to credential issues',
      severity: 'high',
      category: 'config',
      symptoms: [
        'Error: "Authentication failed"',
        'HTTP 401 Unauthorized errors',
        'Cannot connect to Sinch ClickSend API',
      ...
      causes: [
        ...
        'Username doesn\'t match API key',
        'Account suspended or deactivated'
      ],
      solutions: [
        'Double-check username from Sinch ClickSend dashboard',
        'Verify API key is copied correctly',
        'Copy credentials directly from Sinch ClickSend Console',
        'Ensure no extra spaces or newlines in credentials',
        'Generate new API key if needed',
        'Check account status in Sinch ClickSend dashboard'
      ],
      preventive: [
    ...
    },
    {
      ...
      description: 'Phone numbers not accepted by Sinch ClickSend API',
      severity: 'medium',
      category: 'format',
      symptoms: [
    ...
    },
    {
      ...
      causes: [
        'Test mode is enabled in Sinch ClickSend configuration',
    ...
    },
    {
      ...
      description: 'Sinch ClickSend account doesn\'t have enough credit to send messages',
      severity: 'high',
      category: 'account',
      symptoms: [
      ...
      causes: [
        'Sinch ClickSend account balance is too low',
        'Auto-recharge is disabled',
        'Payment method expired or failed',
        'Unexpected high usage'
      ],
      solutions: [
        'Add funds to Sinch ClickSend account',
    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="flex items-center">
          ...
          Sinch ClickSend SMS Troubleshooting Guide
        </CardTitle>
      </CardHeader>
      <CardContent>
                ...
                <CardContent>
                  <div className="space-y-2">
                    <label className="flex items-center space-x-2">
                      ...
                      <span>Verify username is correct from Sinch ClickSend dashboard</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <input type="checkbox" className="rounded" />
                      <span>Confirm API key is copied correctly</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <input type="checkbox" className="rounded" />
                    ...
                    <label className="flex items-center space-x-2">
                      <input type="checkbox" className="rounded" />
                      <span>Verify from number is SMS-enabled in Sinch ClickSend</span>
                    </label>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-2">
                    <label className="flex items-center space-x-2">
                      <input type="checkbox" className="rounded" />
                      <span>Check Sinch ClickSend account balance is sufficient</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <input type="checkbox" className="rounded" />
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-2">
                    <label className="flex items-center space-x-2">
                      <input type="checkbox" className="rounded" />
                      <span>Check Sinch ClickSend dashboard for delivery logs</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <input type="checkbox" className="rounded" />
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg flex items-center">
                    ...
                    Sinch ClickSend Resources
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <a
                    href="https://dashboard.clicksend.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block p-3 border rounded hover:bg-gray-50 transition-colors">
                    <div className="font-medium">Sinch ClickSend Dashboard</div>
                    <div className="text-sm text-muted-foreground">Access your account dashboard and logs</div>
                  </a>
                  
                  <a
                    href="https://developers.clicksend.com/docs/rest/v3/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block p-3 border rounded hover:bg-gray-50 transition-colors">
                    <div className="font-medium">SMS API Documentation</div>
                    <div className="text-sm text-muted-foreground">Complete SMS API documentation</div>
                  </a>

                  <a
                    href="https://help.clicksend.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block p-3 border rounded hover:bg-gray-50 transition-colors">
                    <div className="font-medium">Sinch ClickSend Support</div>
                    <div className="text-sm text-muted-foreground">Get help from Sinch ClickSend support team</div>
                  </a>
                </CardContent>
              </Card>
              ...
              <CardContent>
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    ...
                    <ol className="list-decimal list-inside space-y-1 text-sm">
                      <li>Check Sinch ClickSend service status at status.clicksend.com</li>
                      ...
                      <li>Contact Sinch ClickSend support if all else fails</li>
                    </ol>
                  </AlertDescription>
                </Alert>
              </CardContent>
