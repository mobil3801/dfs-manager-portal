...
*/const calculateOverallScore = (metrics: PerformanceMetrics): number => {let score = 100; // Memory penalty
  ...
  if (metrics.vitals.lcp > 4000) score -= 10;else if (metrics.vitals.lcp > 2500) score -= 5;if (metrics.vitals.cls > 0.25) score -= 10;else if (metrics.vitals.cls > 0.1) score -= 5;return Math.max(0, Math.round(score));};
